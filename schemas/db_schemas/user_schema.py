...
class DeleteUserDbSchema(BaseModel):
    id:str

class GetUserDbSchema(BaseModel):
...
class CreateUserSecretDbSchema(BaseModel):
    id:str
    user_id:str
    client_secret:str

class UpdateUserSecretDbSchema(BaseModel):
    id:str
    user_id:str
    client_secret:Optional[str]=None

class DeleteUserSecretDbSchema(BaseModel):
    id:str
    user_id:str

class GetUserSecretDbSchema(BaseModel):
    limit:int=Field(default=10,lt=100)
    offset:int=Field(default=1)

class GetUserSecretByUserSchema(BaseModel):
    user_id:str
    limit:int=Field(default=10,lt=100)
    offset:int=Field(default=1)

class GetUserSecretByIdSchema(BaseModel):
    id:str


# User settings Modal
class CreateUserSettingDbSchema(BaseModel):
    id:str
    user_id:str
